...
function setup(){
  ...
  video.hide()
  loadd=ml5.poseNet(video,modelLoaded);
  loadd.on('pose',gotPoses)
}
...
function gotPoses(results){
  if (results.length>0){
    ...
    rightWristScore=results[0].pose.keypoints[10].score;
		console.log("right Wrist X = ",rightWristX,"and rightWristY = ",rightWristY,"and rightWristScore = ",rightWristScore);
}
}
